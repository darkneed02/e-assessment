                    ...
                    <div class="col-8">
                        <div class="form-group row">
                            <div class="col-sm">
                                ...
                                <select id="txtSide" name="txtSide" class="form-select border-danger" required>
                                    <option value="" selected disabled>กรุณาเลือก</option>
                                    <option value="Productside">ด้านผลิตภัณฑ์</option>
                                    <option value="Serviceside">ด้านบริการ</option>
                                </select>
                            </div>
                    ...
                    <div class="col-8">
                        <div class="form-group row">
                            <div class="col-sm">
                                ...
                                <select id="txtMonth" name="txtMonth" class="form-select border-danger" required>
                            ...
                            <div class="col-sm">
                                ...
                                <select id="txtYear" name="txtYear" class="form-select border-danger" required>
                                    <option value="กรุณาเลือก" selected>กรุณาเลือก</option>
                                    ...
                                    <table class="table table-bordered table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoTime1" id="rdoTime11" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime1" id="rdoTime12" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime1" id="rdoTime13" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime1" id="rdoTime14" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime1" id="rdoTime15" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">1.2 ความรวดเร็วในการให้บริการ</td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime2" id="rdoTime21" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime2" id="rdoTime22" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime2" id="rdoTime23" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime2" id="rdoTime24" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoTime2" id="rdoTime25" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoService1" id="rdoService11" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService1" id="rdoService12" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService1" id="rdoService13" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService1" id="rdoService14" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService1" id="rdoService15" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">2.2 การจัดลำดับขั้นตอนการให้บริการตามที่ประกาศไว้</td>
                                                <td><input class="form-check-input" type="radio" name="rdoService2" id="rdoService21" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService2" id="rdoService22" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService2" id="rdoService23" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService2" id="rdoService24" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService2" id="rdoService25" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">2.3 การให้บริการตามลำดับก่อนหลัง เช่น มาก่อนต้องได้รับบริการก่อน</td>
                                                <td><input class="form-check-input" type="radio" name="rdoService3" id="rdoService31" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService3" id="rdoService32" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService3" id="rdoService33" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService3" id="rdoService34" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoService3" id="rdoService35" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService1" id="rdoPersonService11" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService1" id="rdoPersonService12" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService1" id="rdoPersonService13" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService1" id="rdoPersonService14" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService1" id="rdoPersonService15" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">3.2 ความเต็มใจและความพร้อมในการให้บริการอย่าสุภาพ</td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService2" id="rdoPersonService21" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService2" id="rdoPersonService22" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService2" id="rdoPersonService23" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService2" id="rdoPersonService24" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService2" id="rdoPersonService25" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">3.3 ความรู้ความสามารถในการให้บริการ เช่น สามารตอบคำถาม ชี้แจงข้อสงสัยให้คำแนะนำได้ เป็นต้น</td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService3" id="rdoPersonService31" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService3" id="rdoPersonService32" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService3" id="rdoPersonService33" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService3" id="rdoPersonService34" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService3" id="rdoPersonService35" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService4" id="rdoPersonService41" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService4" id="rdoPersonService42" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService4" id="rdoPersonService43" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService4" id="rdoPersonService44" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService4" id="rdoPersonService45" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">3.5 การให้บริการเหมือนกันทุกรายโดยไม่เลือกปฏิบัติ</td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService5" id="rdoPersonService51" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService5" id="rdoPersonService52" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService5" id="rdoPersonService53" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService5" id="rdoPersonService54" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoPersonService5" id="rdoPersonService55" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities1" id="rdoFacilities11" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities1" id="rdoFacilities12" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities1" id="rdoFacilities13" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities1" id="rdoFacilities14" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities1" id="rdoFacilities15" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">4.2 จุด /ช่อง การให้บริการมีความเหมาะสมและเข้าถึงได้สะดวก</td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities2" id="rdoFacilities21" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities2" id="rdoFacilities22" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities2" id="rdoFacilities23" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities2" id="rdoFacilities24" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities2" id="rdoFacilities25" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities3" id="rdoFacilities31" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities3" id="rdoFacilities32" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities3" id="rdoFacilities33" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities3" id="rdoFacilities34" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities3" id="rdoFacilities35" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">4.4 ความสะอาดของสถานที่ให้บริการ (ไม่นับผู้ให้บริการขนส่ง จำนวน 4 ราย)</td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities4" id="rdoFacilities41" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities4" id="rdoFacilities42" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities4" id="rdoFacilities43" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities4" id="rdoFacilities44" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoFacilities4" id="rdoFacilities45" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoProduct1" id="rdoProduct11" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct1" id="rdoProduct12" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct1" id="rdoProduct13" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct1" id="rdoProduct14" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct1" id="rdoProduct15" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">5.2 คุณสมบัติของผลิตภัณฑ์เป็นไปตามมาตรฐานสากล (ไม่นับผู้ให้บริการขนส่ง จำนวน 4 ราย)</td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct2" id="rdoProduct21" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct2" id="rdoProduct22" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct2" id="rdoProduct23" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct2" id="rdoProduct24" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct2" id="rdoProduct25" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">5.3 เจ้าหน้ามีการให้บริการและคำแนะนำหลังการขาย</td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct3" id="rdoProduct31" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct3" id="rdoProduct32" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct3" id="rdoProduct33" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct3" id="rdoProduct34" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoProduct3" id="rdoProduct35" value="ไม่พอใจมาก"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">6. ท่านมีความพึงพอใจ / ไม่พึงพอใจต่อการให้บริการในภาพรวม อยู่ในระดับใด</td>
                                                <td><input class="form-check-input" type="radio" name="rdoOverall1" id="rdoOverall11" value="พอใจมาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoOverall1" id="rdoOverall12" value="พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoOverall1" id="rdoOverall13" value="พอใจน้อย"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoOverall1" id="rdoOverall14" value="ไม่พอใจ"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoOverall1" id="rdoOverall15" value="ไม่พอใจมาก"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset class="row mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="ckbDissatisfaction" id="ckbSale1" value="พึงพอใจทุกด้าน">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="ckbDissatisfaction" id="ckbSale2" value="ไม่พึงพอใจ">
                                    ...
                                    <fieldset class="row mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control  mb-1" name="txtCustomerTimeService" id="txtCustomerTimeService" placeholder="อื่นๆ โปรดระบุ"></textarea>
                                            </div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control mb-1" name="txtCustomerProcessingService" id="txtCustomerProcessingService" placeholder="อื่นๆ โปรดระบุ"></textarea>
                                            </div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control mb-1" name="txtCustomerPersionService" id="txtCustomerPersionService" placeholder="อื่นๆ โปรดระบุ"></textarea>
                                            </div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-10">
                                                ...
                                                <textarea class="form-control mb-1" name="txtCustomerFacilitate" id="txtCustomerFacilitate" placeholder="อื่นๆ โปรดระบุ"></textarea>
                                            </div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-10">
                                                <label class="form-check-label mb-1" for="rdoJob6"><b>5. ด้านผลิตภัณฑ์</b> โปรดระบุ พร้อมข้อเสนอแนะเพื่อการปรับปรุง</label>
                                                <textarea class="form-control mb-1" name="txtCustomerProductSide" id="txtCustomerProductSide" placeholder="อื่นๆ โปรดระบุ"></textarea>
                                            </div>
                                            <div class="col-sm-1"></div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <table class="table table-bordered table-hover" style="text-align: center;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation1" id="rdoAffiliation11" value="มาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation1" id="rdoAffiliation12" value="ปานกลาง"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation1" id="rdoAffiliation13" value="น้อย"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">2. ท่านจะกลับมาใช้บริการและซื้อผลิตภัณฑ์ของ กยท. อีกครั้ง</td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation2" id="rdoAffiliation21" value="มาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation2" id="rdoAffiliation22" value="ปานกลาง"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation2" id="rdoAffiliation23" value="น้อย"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">3. ท่านจะเป็นลูกค้าของ กยท. ต่อไป</td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation3" id="rdoAffiliation31" value="มาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation3" id="rdoAffiliation32" value="ปานกลาง"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation3" id="rdoAffiliation33" value="น้อย"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">4. ท่านจะแนะนำการให้บริการและผลิตภัณฑ์ของ กยท.แก่ผู้อื่น</td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation4" id="rdoAffiliation41" value="มาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation4" id="rdoAffiliation42" value="ปานกลาง"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation4" id="rdoAffiliation43" value="น้อย"></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">5. ท่านต้องการรับรู้ข้อมูลข่าวสารของการให้บริการและผลิตภัณฑ์ของ กยท.</td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation5" id="rdoAffiliation51" value="มาก"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation5" id="rdoAffiliation52" value="ปานกลาง"></td>
                                                <td><input class="form-check-input" type="radio" name="rdoAffiliation5" id="rdoAffiliation53" value="น้อย"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="txtSuggestions" name="txtSuggestions" class="form-control" style="height: 100px"></textarea>
                                        </div>
                                    </div>
                                    <hr>
